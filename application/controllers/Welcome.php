...
class Welcome extends CI_Controller {
	...
	public function form_edit_mahasiswa($id) {
		...
		$this->load->view('form-edit-mahasiswa', $data);
	}
	...
	public function insert_mahasiswa() {
		...
		if ($result) {
			...
			redirect(base_url('view-mahasiswa')); // Redirect ke halaman view mahasiswa
		} else {
...
public function form_edit_dosen($id) {
	...
	$this->load->view('form-edit-dosen', $data);
}
...
public function insert_dosen() {
	...
	if ($result) {
		...
		redirect(base_url('view-dosen')); // Redirect ke halaman view mahasiswa
	} else {
		echo "Data gagal disimpan";
	}
}
...
public function form_edit_kelas($id) {
	...
	$this->load->view('form-edit-kelas', $data);
}
...
public function edit_kelas() {
    ...
    if ($result){
        redirect(base_url('view-kelas')); // Ubah redirect ke view-kelas
    } else {
        //echo "Gagal edit data!";
    }
}
...
public function insert_kelas() {
	...
	if ($result) {
		...
		redirect(base_url('view-kelas')); // Redirect ke halaman view mahasiswa
	} else {
		echo "Data gagal disimpan";
	}
}
